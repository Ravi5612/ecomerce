...
const Navbar = () => {
  ...
  return (
    <ResizeableNavbarContainer className="fixed inset-x-0 top-0 z-50 w-full  shadow-sm">
      {/* Desktop Navbar */}
      <NavBody className="hidden lg:flex relative justify-between items-center">
        ...
        <div className='flex items-center gap-6 flex-shrink-0'>
          ...
          >
            ...
            {token && (
              <div
                className={`absolute dropdown-menu right-0 pt-4 transition-all duration-200 z-50 ${
      ...
      {/* Mobile Navbar */}
      <div className="flex lg:hidden items-center justify-between px-4 py-2  shadow-sm">
        {/* Logo */}
      ...
      {/* Mobile Slide Menu */}
      <MobileNav visible={mobileOpen} className="flex lg:hidden">
